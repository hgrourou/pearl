...
(function () {
  ...
  var URL = window.UEDITOR_HOME_URL || getUEBasePath();
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "http://www.talkingpearl.com/admin/add"
        ...
        , toolbars: [[
            ...
            'rowspacingtop', 'rowspacingbottom', 'lineheight', '|','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','directionalityltr', 'directionalityrtl', 'indent', '|',
            'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
            'touppercase', 'tolowercase', '|',
            'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
            'simpleupload', 'insertimage', 'emotion', 'insertvideo', 'music', 'attachment', 'insertcode', 'pagebreak', 'horizontal', 'date', 'time', 'spechars', '|',
